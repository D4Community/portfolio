  ...
  return {
    ...
    contact: {
      ...
      social: {
        GitHub: {
          name: "GitHub",
          url: github?.url || "https://github.com/itsayu",
          icon: Icons.github,
          navbar: true,
        },
        LinkedIn: {
          name: "LinkedIn",
          url: linkedin?.url || "https://linkedin.com/in/itsayu",
          icon: Icons.linkedin,
          navbar: true,
        },
        X: {
          name: "X",
          url: twitter?.url || "https://twitter.com/its_AKT_",
          icon: Icons.x,
          navbar: false,
        },
        Instagram: {
          name: "Instagram",
          url: instagram?.url || "https://instagram.com/its_a.k.t",
